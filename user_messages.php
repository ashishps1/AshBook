    ...
    <div class="header">
      ...
      <div class="menu_nav">
        <ul>
			...
			<li class="active"><a href="user_messages.php?user_name=<?php echo $_SESSION["username"]; ?>">Messages</a></li>
        ...
        <div class="mainbar">
          <div class="article">
            ...
            <?php
				...
				$query="select messages from login_info where user_name ='{$user_name}'";
				...
				if($res){
					...
					foreach($messages as $message){
						...
						if($size>=2){
							echo "<div class=\"post_box\">{$message}</div>";
							$size--;
						}
