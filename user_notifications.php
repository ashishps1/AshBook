...
<head>
<title>AshBook | Notifications</title>
    ...
    <div class="header">
      ...
      <div class="menu_nav">
        <ul>
			...
			<li class="active"><a href="user_notifications.php?user_name=<?php echo $_SESSION["username"]; ?>">Notifications</a></li>
        ...
        <div class="mainbar">
          <div class="article">
            ...
            <?php
				...
				$query="select notifications,profile_pic from login_info where user_name ='{$user_name}'";
				...
				$res=$row["notifications"];
				$res=trim($res);
				$notifications=explode('brutus',$res);
				$size=count($notifications);
				if($res){
					foreach($notifications as $notification){
						if($size>=2){
							echo "<div class=\"post_box\">{$notification}</div>";
							$size--;
						}
					}
				}
