    ...
    <div class="header">
      ...
      <div class="menu_nav">
        <ul>
			...
			?></li>
			<li class="active"><a href="user_timeline.php?user_name=<?php echo $_SESSION["username"]; ?>"><?php echo $_SESSION["name"]; ?></a></li>
        ...
        <div class="mainbar">
          <div class="article">
				...
				if(isset($_GET["user_req"]))
					$user_name=$_GET["user_req"];
				else
					$user_name=$_SESSION["username"];
				$query="select timeline,profile_pic from login_info where user_name ='{$user_name}'";
				...
				if($res){
					foreach($posts as $post){
						if($size>=2){
							...
							echo "<div class=\"post_box\">{$post}</div>";
							$size--;
						}
					}
				}
